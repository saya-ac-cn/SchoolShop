        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item diy" pc>
                    <a href="/view/shop/message.html"><i class="iconfont icon-gonggao"></i><cite>系统公告</cite></a>
                </li>
...
<script type="text/javascript" src="assets/js/shopNav.js"></script>
