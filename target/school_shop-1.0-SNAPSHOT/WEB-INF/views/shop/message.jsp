            ...
            <form action="" class="layui-form" id="query_form">
                <div class="layui-inline">
                    <div class="layui-input-inline" style="width: 200px;">
                        <input type="text" id="query_date" class="layui-input" autocomplete="off" placeholder="发送时间" style="width:200px"/>
                    </div>
                </div>
...
<script type="text/javascript">
    var layer,form,$,upload,flow,table,messageTable;
    ...
    layui.use(['layer', 'jquery', 'form','upload','flow','table','element','laydate'], function () {
        ...
        messageTable = table.render({
            id: 'mainTable',
            elem: '#table',
            //data:[],
            url:"/api/shop/message.yht",
            method:'get',
            loading: true,
            ...
            cols:  [[
                ...
                {title:'发送者', field: 'send',align:'left'},
                {title:'标题', field: 'title',align:'left'},
                {title:'发送时间',field:'datetime',align:'left'},
                {title:'查看', field: null,align:'center', toolbar: '#barDemo'}
            ]],
