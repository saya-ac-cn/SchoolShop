...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../../assets/admin_login/css/login.css">
    <script type="text/javascript" src="../../assets/admin_login/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="../../assets/tools/layui-v2.2.6/layui.js"></script>
    <script type="text/javascript" src="../../assets/admin_login/js/login.js"></script>
</head>
            ...
            <div class="con_right">
                <div class="con_r_top">
                    <a href="javascript:;" class="right"
                       style="color: rgb(51, 51, 51); border-bottom-width: 2px; border-bottom-style: solid; border-bottom-color: rgb(46, 85, 142);">运维人员登录</a>
                </div>
                <ul>
